...
train_gen = generator.flow_from_directory('PokemonData/',
                                          target_size=(220, 220), batch_size=32, class_mode='categorical',
                                          subset='training')

test_gen = generator.flow_from_directory('PokemonData/',
                                          target_size=(220, 220), batch_size=32, class_mode='categorical',
                                          subset='validation')
